<template>
  <div class="component_container">
    <CompanyDocumentsFilter @close="toggleFilter" :is-show="filterActive" :serviceFilter="true"
...
import CompanyTab from "components/Company/CompanyClientServiceTab";
...
export default defineComponent({
  ...
  setup() {
    ...
    let type_document_options = getEnumOptions("getDocumentType")
    ...
    function loadData(pagination) {
      ...
      apiList.documentCompany
        .list(pagination, filter, item.id)
        .then((res) => {
          Table.loading = false;
          if (res) {
            Table.assign(res);

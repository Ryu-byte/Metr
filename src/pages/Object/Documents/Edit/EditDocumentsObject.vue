  ...
  setup: function () {
    ...
    async function deleteFile(index, id) {
      if (id == undefined) {
        ...
        await store.dispatch("object/DeleteObjectDocument", id);
    ...
    async function loadData() {
      try {
        await store.dispatch(
          "object/getSingleObjectDocument",
          route.params.item
        );
        let data = store.getters["object/getDocumentObject"];
    ...
    async function send() {
      ...
      try {
        ...
        formData.append("house_id", route.params.id);
        ...
        await store.dispatch("object/UpdateObjectDocument", formData);
        let res = store.getters["object/getDocumentObject"];
        if (res) {
          $q.notify({
            color: "positive",
            message: res.message,
          ...
          $q.loading.hide();
          await router.push(`/objects/single=${route.params.id}/documents`)
        }
        fileInfos.value = [];
      } catch (e) {
        $q.loading.hide();

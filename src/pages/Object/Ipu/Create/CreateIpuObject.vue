<template>
  <div class="component_container object">
    <div class="forms">
      <main>
        <div class="tittle q-mb-lg">Добавить ИПУ</div>
...
import {getEnumOptions, selectCompany, selectObject, toUnixFormat} from "src/lib/helpers";
  ...
  setup() {
    ...
    const save = async () => {
      ...
      try {
        ...
        await store.dispatch("object/CreateIpu", sentForm);

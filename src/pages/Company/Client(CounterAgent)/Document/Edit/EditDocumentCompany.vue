  ...
  setup: function () {
    ...
    async function deleteFile(index, id) {
      if (id == undefined) {
        ...
        await store.dispatch("document/DeleteDocumentClientFile", id);
    ...
    async function loadData() {
      try {
        await store.dispatch(
          "document/getSingleDocumentClient",
          route.params.item
        );
        let data = store.getters["document/getDocumentClient"];
    ...
    async function send() {
      ...
      try {
        ...
        await store.dispatch("document/updateDocumentClient", formData);
